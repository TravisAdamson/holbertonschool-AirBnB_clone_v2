...
class TestAmenity(unittest.TestCase):
    """ Tests designed to test all functions of the Amenity class """

    @classmethod
    def setUpClass(cls):
        """ Set up for tests """
        cls.amenity = Amenity()
        cls.amenity.name = "FakeData"

    @classmethod
    def teardown(cls):
        """ After testing is complete, removes the instance created """
        del cls.amenity

    def tearDown(self):
        """ After testing is complete, removes the json file it created """
        try:
            os.remove("file.json")
        except Exception:
            pass
